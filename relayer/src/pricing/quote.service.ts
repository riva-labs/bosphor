...
export class QuoteService {
  ...
  async quote(req: QuoteRequest): Promise<Quote> {
    ...
    // Per-network preset: testnet-calibrated default on testnet, required on mainnet.
    const returnLzFeeMist = BigInt(this.config.getOrThrow<string>('QUOTE_RETURN_LZ_FEE_MIST'));
