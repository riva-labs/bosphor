...
description: "The canary runs a real end-to-end round-trip on a fixed interval, the primary signal that the whole cross-chain path is healthy."
---
...
- [Relayer Operator Guide](/docs/protocol/relayer) for the service the canary exercises
