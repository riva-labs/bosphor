...
The priced tests exercise the origin-chain payment flow (see [Payment flow](/docs/guides/pay-for-storage)) on live testnet infrastructure. Neither runs in CI.
...
- [Contract Interface](/docs/contracts/evm-adapter) for function signatures referenced in tests
