...
description: "What Bosphor trusts and what it verifies: DVN-verified messages both ways, and a relayer that cannot forge proofs."
---
...
- [Known Limitations](/docs/protocol/known-limitations) for operational constraints
- [LZ Verification Flow](/docs/protocol/lz-verification-flow) for DVN verification details
