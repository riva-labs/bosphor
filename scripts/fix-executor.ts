...
// wBTC executor on Sui mainnet
const WBTC_EXECUTOR = "0xde7fe1a6648d587fcc991f124f3aa5b6389340610804108094d5c5fbf61d1989";
...
async function main() {
  console.log(`Fixing executor config on Sui for EVM EID ${EVM_EID}`);
  console.log(`  Old executor: ${process.env.SUI_LZ_EXECUTOR_PKG}`);
  console.log(`  New executor (wBTC): ${WBTC_EXECUTOR}`);

  const tx = new Transaction();
  const execConfig = encodeExecutorConfig(10000n, WBTC_EXECUTOR);
